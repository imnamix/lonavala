...
const iconMap: Record<string, React.ReactNode> = {
  ...
  Baby: <Baby className="w-8 h-8 text-[#2E8B57]" />,
  FileHeart: <FileHeart className="w-8 h-8 text-[#2E8B57]" />,
  Building2: <Building2 className="w-8 h-8 text-[#2E8B57]" />,
  Briefcase: <Briefcase className="w-8 h-8 text-[#2E8B57]" />,
  FileCheck: <FileCheck className="w-8 h-8 text-[#2E8B57]" />,
  CreditCard: <CreditCard className="w-8 h-8 text-[#2E8B57]" />,
};
...
export default async function ServiceDetailPage({
  ...
  const icon = iconMap[service.icon] || <FileCheck className="w-8 h-8 text-[#2E8B57]" />;
  ...
  return (
    <div className="py-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className="text-2xl sm:text-3xl font-extrabold text-[#1F2937] mt-2">
                  {service.title}
                </h1>
                <p className="text-xs sm:text-sm text-gray-600 mt-1 flex items-center gap-1">
                  <Building className="w-3.5 h-3.5 text-[#2E8B57]" />
            ...
            <a
              ...
              className="px-6 py-3.5 rounded-xl bg-[#2E8B57] hover:bg-[#246E45] text-white font-bold text-sm shadow-md hover:shadow-lg transition-all flex items-center gap-2 shrink-0"
            >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-white p-6 rounded-2xl border border-[#D9E8DD] shadow-xs">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#E8F5E9] flex items-center justify-center text-[#2E8B57] shrink-0">
              <Clock className="w-5 h-5" />
            </div>
            <div>
              <div className="text-xs font-bold text-gray-500 uppercase">Service Timeline</div>
              <div className="text-sm font-bold text-[#1F2937] mt-0.5">{service.timeline}</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-[#1F2937] mt-0.5">{service.fees}</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-[#1F2937] mt-0.5">{service.department}</div>
            </div>
          </div>
        </div>

        {/* Description */}
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#D9E8DD] shadow-xs space-y-3">
          <h2 className="text-lg font-bold text-[#1F2937]">Service Description & Objectives</h2>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#D9E8DD] shadow-xs space-y-4">
          <h3 className="text-base font-bold text-[#1F2937]">Step-by-Step Application Procedure</h3>
          <div className="space-y-3">
            {service.steps.map((step, idx) => (
              <div key={idx} className="flex items-start gap-3 bg-[#F8FCF9] p-3.5 rounded-xl border border-[#D9E8DD]">
                <span className="w-6 h-6 rounded-full bg-[#2E8B57] text-white text-xs font-bold flex items-center justify-center shrink-0">
                  {idx + 1}
                </span>
        ...
        <div className="bg-[#F8FCF9] p-6 rounded-2xl border border-[#D9E8DD] flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <div className="text-xs font-bold text-gray-500 uppercase">Departmental In-Charge</div>
            <div className="text-sm font-bold text-[#1F2937] mt-0.5">{service.contactPerson}</div>
          </div>
          <a
            href={service.onlinePortalUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-3 rounded-xl bg-[#2E8B57] hover:bg-[#246E45] text-white font-bold text-xs sm:text-sm shadow-xs transition-colors flex items-center gap-1.5"
          >
            <span>Go to Official Portal</span>
            <ExternalLink className="w-4 h-4" />
          </a>
