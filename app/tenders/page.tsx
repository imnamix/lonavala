    ...
    <div className="py-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-border shadow-xs">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <select
              ...
              className="px-3.5 py-2.5 text-xs bg-white border border-border rounded-xl text-gray-700 font-semibold focus:outline-hidden"
            >
            ...
            <a
              ...
              className="px-4 py-2.5 bg-primary hover:bg-primary-hover text-white font-bold text-xs rounded-xl shadow-xs transition-colors shrink-0"
            >
              MahaTenders Portal ↗
            </a>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-border overflow-hidden shadow-xs">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100 text-xs text-gray-700">
                {paginated.map((tender) => (
                  <tr key={tender.id} className="hover:bg-primary-light/30 transition-colors">
                    <td className="py-4 px-6 font-mono font-bold text-primary whitespace-nowrap">
                      {tender.tenderId}
                    </td>
                    <td className="py-4 px-6 max-w-sm">
                      <div className="font-bold text-text-primary leading-snug line-clamp-2">
                        {tender.title}
                      </div>
                    ...
                    <td className="py-4 px-6 text-center whitespace-nowrap">
                      <a
                        href="#"
                        download
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-gray-100 hover:bg-primary hover:text-white text-gray-700 font-semibold transition-colors"
          ...
          {/* Pagination Controls */}
          <div className="p-4 bg-primary-surface border-t border-border flex items-center justify-between text-xs text-gray-600">
            <div>
