    ...
    <div className="py-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-3xl border border-border shadow-xs">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 rounded-xl bg-primary hover:bg-primary-hover text-white font-bold text-xs flex items-center gap-2 shadow-xs transition-colors"
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-border overflow-hidden shadow-xs">
              <div className="p-4 bg-primary-surface border-b border-border text-xs font-bold text-gray-700 flex items-center gap-1.5">
              ...
              <div className="relative h-48 bg-emerald-50 flex items-center justify-center p-6 text-center">
                <div className="space-y-2">
                  <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center mx-auto shadow-md">
        ...
        <div className="bg-white rounded-3xl border border-border p-6 sm:p-8 shadow-xs space-y-4">
          <h3 className="text-lg font-bold text-text-primary">Departmental Telephone Extensions</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
            {DEPARTMENTS.map((dept) => (
              <div key={dept.id} className="p-3.5 rounded-xl bg-primary-surface border border-border space-y-1">
                <div className="font-bold text-xs text-text-primary truncate">{dept.name}</div>
                <div className="text-[11px] text-primary font-semibold">{dept.phone}</div>
